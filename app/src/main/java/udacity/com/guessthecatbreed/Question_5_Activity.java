...
public class Question_5_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catImage.setImageResource(R.drawable.munchkin_5);

        numberOfQuestion = (TextView) findViewById(R.id.number_of_question);
        numberOfQuestion.setText("Question №5");
        ...
        chekboxButton1.setText(getString(R.string.egyptian_mau));
        chekboxButton2.setText(getString(R.string.ragamuffin));
        chekboxButton3.setText(getString(R.string.european_shorthair));
        chekboxbutton4.setText(getString(R.string.munchkin));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button_next:
                Intent intent = new Intent(this, Question_6_Activity.class);
