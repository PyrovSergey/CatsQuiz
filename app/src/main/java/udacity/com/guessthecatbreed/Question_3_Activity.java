...
public class Question_3_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catImage.setImageResource(R.drawable.british_shorthair_q3);

        numberOfQuestion = (TextView) findViewById(R.id.number_of_question);
        numberOfQuestion.setText("Question №3");
        ...
        chekboxButton1.setText(getString(R.string.khao_manee));
        chekboxButton2.setText(getString(R.string.japanese_bobtail));
        chekboxButton3.setText(getString(R.string.persian));
        chekboxbutton4.setText(getString(R.string.british_shorthair));
