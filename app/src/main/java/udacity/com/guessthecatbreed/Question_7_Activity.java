...
public class Question_7_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catImage.setImageResource(R.drawable.bengal_q7);

        numberOfQuestion = (TextView) findViewById(R.id.number_of_question);
        numberOfQuestion.setText("Question №7");
        ...
        chekboxButton1.setText(getString(R.string.bengal));
        chekboxButton2.setText(getString(R.string.snowshoe));
        chekboxButton3.setText(getString(R.string.ocicat));
        chekboxbutton4.setText(getString(R.string.chantilly_tiffany));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button_next:
                Intent intent = new Intent(this, Question_8_Activity.class);
