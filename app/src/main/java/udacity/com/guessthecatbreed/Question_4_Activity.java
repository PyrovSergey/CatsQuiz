...
public class Question_4_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catImage.setImageResource(R.drawable.ragamuffin_q4);

        numberOfQuestion = (TextView) findViewById(R.id.number_of_question);
        numberOfQuestion.setText("Question №4");
        ...
        chekboxButton1.setText(getString(R.string.british_shorthair));
        chekboxButton2.setText(getString(R.string.ragamuffin));
        chekboxButton3.setText(getString(R.string.munchkin));
        chekboxbutton4.setText(getString(R.string.german_rex));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button_next:
                Intent intent = new Intent(this, Question_5_Activity.class);
