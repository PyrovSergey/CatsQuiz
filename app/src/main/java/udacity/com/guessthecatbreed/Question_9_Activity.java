...
public class Question_9_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catImage.setImageResource(R.drawable.siberian_q9);

        numberOfQuestion = (TextView) findViewById(R.id.number_of_question);
        numberOfQuestion.setText("Question №9");
        ...
        chekboxButton1.setText(getString(R.string.singapura));
        chekboxButton2.setText(getString(R.string.chausie));
        chekboxButton3.setText(getString(R.string.siberian));
        chekboxbutton4.setText(getString(R.string.ocicat));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button_next:
                Intent intent = new Intent(this, Question_10_Activity.class);
