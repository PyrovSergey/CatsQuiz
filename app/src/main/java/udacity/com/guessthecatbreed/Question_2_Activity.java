...
public class Question_2_Activity extends AppCompatActivity implements View.OnClickListener {
    ImageView catImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catImage.setImageResource(R.drawable.chartreux_q2);

        numberOfQuestion = (TextView) findViewById(R.id.number_of_question);
        numberOfQuestion.setText("Question №2");
        ...
        chekboxButton1.setText(getString(R.string.snowshoe));
        chekboxButton2.setText(getString(R.string.british_shorthair));
        chekboxButton3.setText(getString(R.string.chartreux));
        chekboxbutton4.setText(getString(R.string.american));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button_next:
                Intent intent = new Intent(this, Question_3_Activity.class);
