...
public class Question_10_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catImage.setImageResource(R.drawable.snowshoe_q10);

        numberOfQuestion = (TextView) findViewById(R.id.number_of_question);
        numberOfQuestion.setText("Question №10");
        ...
        chekboxButton1.setText(getString(R.string.british_semi_longhair));
        chekboxButton2.setText(getString(R.string.snowshoe));
        chekboxButton3.setText(getString(R.string.california_spangled));
        chekboxbutton4.setText(getString(R.string.abyssinian));
