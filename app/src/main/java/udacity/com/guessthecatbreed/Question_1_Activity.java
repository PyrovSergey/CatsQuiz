...
public class Question_1_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catImage.setImageResource(R.drawable.persian_q1);

        numberOfQuestion = (TextView) findViewById(R.id.number_of_question);
        numberOfQuestion.setText("Question №1");
        ...
        chekboxButton1.setText(getString(R.string.persian));
        chekboxButton2.setText(getString(R.string.birman));
        chekboxButton3.setText(getString(R.string.ragdoll));
        chekboxbutton4.setText(getString(R.string.exotic_shorthair));
